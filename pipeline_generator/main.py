...
from pipeline_generator.config.constants import IMAGE_DEFAULT, ENABLE_ASDF
...
def generate_pipeline(image_registry, out_filename, extra_known_hosts,enable_asdf, git_provider, branch_name, export_aws_vars):
